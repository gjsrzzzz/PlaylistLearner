...
public class Playlist
{
    ...
    public static Playlist Academia2005 = new Playlist()
    {
        ...
        Items =
        {
            ...
            new PlaylistItem(ItemType.Default, Format.Standard, "Open and Close", "",
                "", "https://youtu.be/ue-P8DoJ29Q", 21, 31),
            new PlaylistItem(ItemType.Default, Format.Standard, "Dile que no", "",
                "", "https://youtu.be/ue-P8DoJ29Q", 31, 36),
            new PlaylistItem(ItemType.Default, Format.Standard, "Guapea", "",
                "", "https://youtu.be/ue-P8DoJ29Q", 36, 40),
            new PlaylistItem(ItemType.Default, Format.Standard, "Enchufe", "",
                "", "https://youtu.be/ue-P8DoJ29Q", 40, 49),
            new PlaylistItem(ItemType.Default, Format.Standard, "Enchufe doble", "",
                "", "https://youtu.be/ue-P8DoJ29Q", 49, 62),
            new PlaylistItem(ItemType.Default, Format.Standard, "Enchufe por detras", "",
                "", "https://youtu.be/ue-P8DoJ29Q", 62, 68),
            new PlaylistItem(ItemType.Default, Format.Standard, "Sacala", "Take her out",
                "", "https://youtu.be/ue-P8DoJ29Q", 68, 76),
            new PlaylistItem(ItemType.Default, Format.Standard, "Sombrero", "",
            ...
            new PlaylistItem(ItemType.Default, Format.Standard, "Dedo", "",
                "", "https://youtu.be/ue-P8DoJ29Q", 133, 137),
            new PlaylistItem(ItemType.Default, Format.Standard, "Up close and personal", "",
                "", "https://youtu.be/ue-P8DoJ29Q", 137, 150),
            new PlaylistItem(ItemType.Default, Format.Standard, "Abanico Complicado con Adorno", "Complicated fan with adornment",
            "", "https://youtu.be/CPNBTjto-Jc", 0, 41),
            new PlaylistItem(ItemType.Default, Format.Standard, "Bayamo con Echeverria", "",
                    "", "https://youtu.be/CPNBTjto-Jc", 41, 68),
            new PlaylistItem(ItemType.Default, Format.Standard, "Caminala & Guapea con punta delpie", "Caminala & Guapea with toe-tip",
                    "", "https://youtu.be/CPNBTjto-Jc", 68, 95),
            new PlaylistItem(ItemType.Default, Format.Standard, "Enrosca y Desenrosca", "Twist & Unscrew",
                    "", "https://youtu.be/CPNBTjto-Jc", 95, 120),
            new PlaylistItem(ItemType.Default, Format.Standard, "Paseala por Detras, Arriba y a lo moderno", "Back, Up and Modern",
                    "", "https://youtu.be/CPNBTjto-Jc", 120, 160),
            new PlaylistItem(ItemType.Default, Format.Standard, "Paseala con Adorno", "Walk her with adornment",
